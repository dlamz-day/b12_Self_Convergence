...
read_file -format verilog ../netlist/base_syn.v
read_file -format verilog ../netlist/div2_syn.v
read_file -format verilog ../netlist/timesR_syn.v
read_file -format verilog ../mul/clock.v
